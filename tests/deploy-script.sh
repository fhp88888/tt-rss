...
assert_contains "$up_output" "touch data/config.php"
assert_contains "$up_output" "ln -sfn data/config.php config.php"
assert_contains "$up_output" "chown -R 1000:1000 data/cache data/lock data/plugins.local data/templates.local data/themes.local data/config.php"
assert_contains "$up_output" "chmod 644 data/config.php"
