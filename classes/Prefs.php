...
class Prefs {
	...
	const AI_DIGEST_ARTICLE_COUNT = "AI_DIGEST_ARTICLE_COUNT";
	const AI_DIGEST_LOOKBACK_HOURS = "AI_DIGEST_LOOKBACK_HOURS";
	const AI_DIGEST_CACHE_TTL_MINUTES = "AI_DIGEST_CACHE_TTL_MINUTES";
	const AI_DIGEST_MAX_ARTICLES_SENT = "AI_DIGEST_MAX_ARTICLES_SENT";
	const AI_DIGEST_MAX_PROMPT_CHARS = "AI_DIGEST_MAX_PROMPT_CHARS";
	const AI_DIGEST_LLM_TIMEOUT = "AI_DIGEST_LLM_TIMEOUT";
	...
	private const _DEFAULTS = [
		...
		Prefs::AI_SUMMARY_CONCURRENCY => [ 2, Config::T_INT ],
			Prefs::AI_DIGEST_ARTICLE_COUNT => [ 15, Config::T_INT ],
			Prefs::AI_DIGEST_LOOKBACK_HOURS => [ 24, Config::T_INT ],
			Prefs::AI_DIGEST_CACHE_TTL_MINUTES => [ 120, Config::T_INT ],
			Prefs::AI_DIGEST_MAX_ARTICLES_SENT => [ 120, Config::T_INT ],
			Prefs::AI_DIGEST_MAX_PROMPT_CHARS => [ 100000, Config::T_INT ],
			Prefs::AI_DIGEST_LLM_TIMEOUT => [ 28, Config::T_INT ],
	];
	...
	const _PROFILE_BLACKLIST = [
		...
		Prefs::AI_SUMMARY_CONCURRENCY,
			Prefs::AI_DIGEST_ARTICLE_COUNT,
			Prefs::AI_DIGEST_LOOKBACK_HOURS,
			Prefs::AI_DIGEST_CACHE_TTL_MINUTES,
			Prefs::AI_DIGEST_MAX_ARTICLES_SENT,
			Prefs::AI_DIGEST_MAX_PROMPT_CHARS,
			Prefs::AI_DIGEST_LLM_TIMEOUT,
